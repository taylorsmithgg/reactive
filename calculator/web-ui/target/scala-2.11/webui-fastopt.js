...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  var x = remainingCharsCount.apply__O();
  ...
  if ((x1 >= 15)) {
    ...
    $as_Ljava_io_PrintStream(this$9.tl$1.get__O()).println__O__V("This motherfucker");
    $m_Lcalculator_Signal$();
    var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "yellow"
    }));
    ...
    $as_Ljava_io_PrintStream(this$13.tl$1.get__O()).println__O__V("This actually fucking failed");
    $m_Lcalculator_Signal$();
    var expr$4 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "white"
    }));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, v$1) {
      return (function() {
        $as_Lcalculator_Expr(v$1.apply__O());
        arg$outer.namedExpressions$1$f;
        return 10.0
      })
    })(this, v));
